...
function SimplePlane() {
  ...
  const planeParas = useControls("Plane" , {
    scaleX : { min: 0, max : 5 , value : 1 },
    scaleY : { min: 0, max : 5 , value : 1 },
    scaleZ : { min: 0, max : 5 , value : 1 },
  ...
  return (
    <Plane
      className="SimplePlane  w-1/3 rounded-3xl"
      ...
      uniforms={uniforms}
      // plane events
    scale={[planeParas.scaleX,planeParas.scaleY,planeParas.scaleZ]}
      onReady={onReady}
      onRender={onRender}
