...
<stop offset="1" stopColor="#514F4F"/>
      ...
      <div className='w-full  md:pl-12 text-left md:text-left mt-8 flex  justify-center md:justify-end'>
...
<video className=' w-[90%] rounded-3xl md:w-2/5' src="./videos/video2.mp4"  playsInline muted autoPlay loop></video>
